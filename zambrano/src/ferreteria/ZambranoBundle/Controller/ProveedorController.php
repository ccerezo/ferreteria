...
use ferreteria\ZambranoBundle\Entity\Proveedor;
use ferreteria\ZambranoBundle\Form\ProveedorType;
...
class ProveedorController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ferreteriaZambranoBundle:Proveedor')->findAll();
     ...
     * @Method("POST")
     * @Template("ferreteriaZambranoBundle:Proveedor:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ferreteriaZambranoBundle:Proveedor')->find($id);
     ...
     * @Method("PUT")
     * @Template("ferreteriaZambranoBundle:Proveedor:edit.html.twig")
     */
